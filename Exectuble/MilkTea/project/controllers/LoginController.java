...
public class LoginController implements Initializable {
    ...
    * programLogo = logo of this project
    ...
    public void initialize(URL location, ResourceBundle resources)    {
        ...
        //loginPane.getStylesheets().add(getClass().getResource(dirPath"/text/css/jfxStyle_0.css").toExternalForm());
    }
    ...
    public void goToHomeScreen() throws IOException {
        ...
        FXMLLoader loader = new FXMLLoader(getClass().getResource("project/fxml/HomeScreen.fxml"));
